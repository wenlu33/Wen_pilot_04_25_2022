...
class C(BaseConstants):
    ...
    PLAYERS_PER_GROUP = 2
    NUM_ROUNDS = 7
    INSTRUCTIONS_TEMPLATE = 'Wenpilot_TD_R/instructions.html'
...
class aMyWaitPage(WaitPage):
    template_name = 'Wenpilot_TD_R/aMyWaitPage.html'
...
page_sequence = [Introduction,
                new_assign_page, aMyWaitPage, Claim, ResultsWaitPage, Results, ResultsWaitPage]
