...
doc = """
This is TD game with communication and regret
"""
...
class C(BaseConstants):
    ...
    PLAYERS_PER_GROUP = 2
    NUM_ROUNDS = 7
    INSTRUCTIONS_TEMPLATE = 'Wenpilot_TDRegret_CR/instructions.html'
...
class Assessment1(Page):
    ...
    def error_message(player: Player, values):
        solutions = dict(q1='40', q2='200', q3='40', q4='M', q5='m - adjustment', q6='m + adjustment')
...
page_sequence = [Introduction, Assessment1,
